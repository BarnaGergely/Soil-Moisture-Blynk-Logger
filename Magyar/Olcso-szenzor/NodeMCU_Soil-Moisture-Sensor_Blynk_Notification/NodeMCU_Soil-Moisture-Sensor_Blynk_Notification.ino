...
int sensorpin = A0;
#define SENSOR D1          // What digital pin where the sensor get the power
...
void sendSensor()
{
  ...
  Blynk.virtualWrite(V6, outputvalue);
}
...
void setup()
{
  ...
  pinMode(SENSOR, OUTPUT); // set the digital pin as output to power the sensor.
